...
const features = [
  {
    ...
    description: 'Clean separation between handlers, repositories, and database. Repository pattern with dependency injection.',
    link: 'architecture',
  },
  {
    icon: Radio,
    title: 'Event-Driven',
    description: 'In-memory pub/sub bus decouples services. Search syncs via Meilisearch, notifications via WhatsApp.',
    link: 'events',
  },
  {
    icon: Database,
    title: 'Dual Database',
    description: 'SQLite in development, Cloudflare D1 in production. Same interface, zero code changes between environments.',
    link: 'database',
  },
  {
    icon: Box,
    title: 'Domain Services',
    description: 'Auth, Products, Orders, Customers, Invoices. Each with its own repository, handlers, and event publishing.',
    link: 'services',
  },
  {
    icon: Code,
    title: 'REST API',
    description: '33 endpoints with JWT auth, Google OAuth, file uploads, and interactive API playground.',
    link: 'architecture',
  },
  {
    icon: Rocket,
    title: 'Dual Deploy',
    description: 'Standalone HTTP server or AWS Lambda. Same handler, same code. ~200ms cold start on arm64.',
    link: 'deployment',
  },
];
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="mx-auto max-w-4xl px-6 pt-24 pb-16 text-center">
            ...
            <p className="text-fd-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Go-powered e-commerce backend with order lifecycle management, product catalog, and admin dashboard.
            </p>
